...
/**
 * This class handles the actual autospelling by implementing some listeners on the spellchecked JEditorPane and
 * Document.
 * 
...
public class AutoSpellCheckHandler extends MouseAdapter implements DocumentListener, AutoSpellConstants {
  ...
  // DBA-FIX-200609 : right mouse support (os-x, linux)
