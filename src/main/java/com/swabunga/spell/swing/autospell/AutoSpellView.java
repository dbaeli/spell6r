...
/**
 * This View just forward all calls to the original view but also paints the waved line if the Elements is marked as
 * misspelled.
 * 
...
public class AutoSpellView extends View implements AutoSpellConstants {
   ...
   * (non-Javadoc)
   * 
   * @see javax.swing.text.View#getNextVisualPositionFrom(int, javax.swing.text.Position.Bias, java.awt.Shape, int,
  ...
  /*
   * public Shape modelToView(int arg0, Shape arg1) throws BadLocationException { return view.modelToView(arg0, arg1); }
   */
   ...
   * (non-Javadoc)
   * 
   * @see javax.swing.text.View#modelToView(int, javax.swing.text.Position.Bias, int, javax.swing.text.Position.Bias,
   * java.awt.Shape)
   */
  ...
  /*
   * public int viewToModel(float arg0, float arg1, Shape arg2) { return view.viewToModel(arg0, arg1, arg2); }
   */
