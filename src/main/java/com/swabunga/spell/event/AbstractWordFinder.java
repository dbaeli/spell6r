...
public abstract class AbstractWordFinder implements WordFinder {
  ...
  /**
   * This method scans the text from the end of the last word, and returns a new Word object corresponding to the next
   * word.
   * 
  ...
  /**
   * Indicates if the character at the specified position is acceptable as part of a word. To be acceptable, the
   * character need to be a letter or a digit. It is also acceptable if the character is one of ''', '@', '.' or '_' and
   * is preceded and followed by letter or digit.
   * 
  ...
  /**
   * Ignores or skip over text starting from the index position specified if it contains the <code>startIgnore</code>,
   * and until the first non letter or digit character is encountered or end of text is detected.
   * 
   * @param index The start position in text.
   * @param startIgnore The character that should be at <code>index</code> position to start skipping through.
   * @return The index position pointing after the skipped characters or the original index if the ignore condition
   *         could not be met.
   */
  ...
  /**
   * Ignores or skip over text starting from the index position specified if it contains the <code>startIgnore</code>,
   * and until the <code>endIgnore</code> character is encountered or end of text is detected.
   * 
   * @param index The start position in text.
   * @param startIgnore The character that should be at <code>index</code> position to start skipping through.
   * @param endIgnore The character which mark the end of skipping through. If the value of endIgnore is
   *          <code>null</code>, skipping characters stop at first non letter or digit character.
   * @return The index position pointing after the skipped characters or the original index if the ignore condition
   *         could not be met.
   */
  ...
  /**
   * Ignores or skip over text starting from the index position specified if it contains the <code>startIgnore</code>
   * string, and until the <code>endIgnore</code> string is encountered or end of text is detected.
   * 
   * @param index The start position in text.
   * @param startIgnore The string that should be at <code>index</code> position to start skipping through.
