 ...
 * <CODE>current()</CODE>, <CODE>startsSentence()</CODE> and <CODE>replace()</CODE>.
 * </P>
 * 
 * <P>
...
public interface WordFinder {
  ...
  /**
   * This method returns the text through which the WordFinder is iterating. The text may have been modified through
   * calls to replace().
   * 
  ...
  /**
   * This method should return the Word object representing the current word in the iteration. This method should not
   * affect the state of the WordFinder object.
   * 
  ...
  /**
   * This method should return the Word object representing the next word in the iteration (the first word if next() has
   * not yet been called.)
   * 
