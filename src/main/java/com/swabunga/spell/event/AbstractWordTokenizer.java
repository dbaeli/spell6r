 ...
 * 
 * <p>
 * It also allows for the string to be mutated. The result after the spell checking is completed is available to the
 * call to getFinalText
 * </p>
 * 
...
public abstract class AbstractWordTokenizer implements WordTokenizer {
  ...
  public String nextWord() {
    ...
    // DBA-FIX-200609: wordCount was not incremented
    wordCount++;
    return currentWord != null ? currentWord.getText() : null;
  }
