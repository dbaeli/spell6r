 ...
 * <p/>
 * As far as I know, we will only require one implementation of the SpellCheckEvent (BasicSpellCheckEvent) but I have
 * defined this interface just in case. The BasicSpellCheckEvent implementation is currently package private.
 * 
...
public interface SpellCheckEvent {
   ...
   * @param replaceAll If set to true, the SpellChecker will replace all further occurrences of the misspelt word
   *          without firing a SpellCheckEvent.
   */
   ...
   * 
   * @param ignoreAll If set to true, the SpellChecker will replace all further occurrences of the misspelt word without
   *          firing a SpellCheckEvent.
   */
