 ...
 * 
 * <p>
 * It also allows for the string to be altered by calls to replaceWord(). The result after the spell checking is
 * completed is available to the call to getContext.
 * </p>
 * 
...
public class StringWordTokenizer extends AbstractWordTokenizer {
   ...
   * Creates a new StringWordTokenizer object.
   * 
   * @param wf the custom WordFinder to use in tokenizing. Note that the string to tokenize will be encapsulated within
   *          the WordFinder.
   */
   ...
   * @param finder the custom WordFinder to use in tokenizing. Note that the string to tokenize will be encapsulated
   *          within the WordFinder.
   */
