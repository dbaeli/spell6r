...
/**
 * The Word object holds information for one suggested spelling. It contains both the suggested word string and the
 * distance cost, which represents how different the suggested word is from the misspelling.
 * <p>
