...
/**
 * An interface for all Transformators - which take a dictionary word and converts into its phonetic hash. These
 * phonetic hashes are useful for determining what other words are similar to it, and then list those words as
 * suggestions.
 * 
...
public interface Transformator {
  ...
  /**
   * gets the list of characters that should be swapped in to the misspelled word in order to try to find more
   * suggestions. In general, this list represents all of the unique phonetic characters for this Transformator.
   * <p/>
