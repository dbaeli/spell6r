...
/**
 * The various settings used to control how a spell checker works are read from here. Includes the COST_* constants that
 * decide how to figure the cost of converting one word to another in the EditDistance class.
 * <p/>
 * Also includes SPELL_* constants that control how misspellings are detected, for example, how to handle mixed-case
 * words, etc.
 * 
 * @author aim4min
 * @see EditDistance
...
public abstract class Configuration {
  ...
  /**
   * used by EditDistance: the cost of having to swap two adjoining characters for the swap value to ever be used, it
   * should be smaller than the COST_REMOVE_CHAR or COST_INSERT_CHAR values <br/>
   * (integer greater than 0)
   */
  public static final String COST_SWAP_CHARS = "EDIT_SWAP";

  /**
   * used by EditDistance: the cost of having to change case, for example, from i to I. <br/>
   * (integer greater than 0)
   */
  public static final String COST_CHANGE_CASE = "EDIT_CASE";

  /**
   * used by EditDistance: the cost of having to substitute one character for another for the sub value to ever be used,
   * it should be smaller than the COST_REMOVE_CHAR or COST_INSERT_CHAR values <br/>
   * (integer greater than 0)
   */
  ...
  /**
   * the maximum cost of suggested spelling. Any suggestions that cost more are thrown away <br/>
  ...
  /**
   * words that look like an Internet address are not spell checked, example: "http://www.google.com" <br/>
   * (boolean)
   */
  public static final String SPELL_IGNOREINTERNETADDRESSES = "SPELL_IGNOREINTERNETADDRESSES";
  /**
  ...
  /**
   * the first word of a sentence is expected to start with an upper case letter <br/>
   * (boolean)
   */
  public static final String SPELL_IGNORESENTENCECAPITALIZATION = "SPELL_IGNORESENTENCECAPITALIZATION";
