...
public class OpenOfficeDictionarySupport {
  ...
  /**
   * Read the dictionary from a ZipInputStream. Use with care because the format and dependencies make a memory Stream.
   * 
   * @param zipStream
   * @throws IOException
   */
  ...
  /**
   * This function add a new word to the current WordManager, but this word is not add permanent, that is, is not save
   * in file.
   * 
